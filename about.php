  ...
  <div class="row content">
    <div class="col-sm-12">
      ...
      <p class="text-justify"><h4>Crown Hotel, situated in Ravi Bhavan, built in modern and unique style with excellent state of the art facilities, is an iconic 4-star luxury hotel that captures the essence of legendary Kathmandu valley, offering a breathtaking panoramic view of the surrounding mountains and one of the prominent world heritage site, Swayambhunath, exposing peace and tranquility. We are inspired by our caring attitude for our guests, people and the environment.
          ...
          The story of Crown Hotel begins with a dream of its owners to build a 4-star deluxe hotel in Nepal providing luxury services to discerning clients, celebrating Nepalese warmth and adding one more milestone in the hospitality industry.

          Our distinctive feature is our highly motivated and well-trained staff who provide exceptionally attentive, personalized and warm service.</p></h4>
<h1 align="center"id="font">[ Services ]</h1><br>
        <p class="text-justify"><h4>Full-service hotels often provide a wide array of guest services and on-site facilities. Commonly found amenities may include: on-site food and beverage (room service and restaurants), meeting and conference services and facilities, fitness center, and business center. Full-service hotels range in quality from mid-scale to luxury. This classification is based upon the quality of facilities and amenities offered by the hotel.</p></h4>
    </div>
  </div><br><br>
...
<!--Map Close Here-->
        <div class="col-sm-2">
          <h4><b>Address</b></h4>
          <b>Hetauda-10,Main Road,Nepal</b>
        </div>
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
