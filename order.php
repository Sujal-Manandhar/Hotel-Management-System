...
echo "<td>".htmlspecialchars($result['country'])."</td>";
echo "<td>".htmlspecialchars($result['room_type'])."</td>";
echo "<td>".htmlspecialchars($result['check_in_date'])."</td>";
echo "<td>".htmlspecialchars($result['check_in_time'])."</td>";
echo "<td>".htmlspecialchars($result['check_out_date'])."</td>";
echo "<td>".htmlspecialchars($result['Occupancy'])."</td>";
echo "<td><a href='cancel_order.php?order_id=".htmlspecialchars($oid)."' style='color:Red'>Cancel</a></td>";
echo "</tr>";
}                         
               ?> 
          </table>
